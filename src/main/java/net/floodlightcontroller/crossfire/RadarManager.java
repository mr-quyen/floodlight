...
//
//	// Event control
//	protected Map<U64, String> detectorNames;  // Crossfire, DNS amplification, or SYN flooding.
//	protected Map<U64, IRadarListener> radarListeners; // ? For what purpose?
//
//	// Configurations
...
//	// can be used by other modules?  e.g., crossfire, ...
...
//
//	// Table ID parameters
//	private Map<DtraceatapathId, Integer> currentDetectionTbl;
...
//		// each flow, port is marked for collection or not
//		// vectorID: to identify a flow
//		// class trace keep track all these information
//
//		// Experiment
...
//		// splitted: IP will be splitted
//		// merged: IP will be merged
...
//					// collected information is processed here.
//					if (dpid == null)
...
//				} jobsLock.unlock();
//
//				// replies queue contains  all requests
//				// to the flow statistics of port statistics
//
...
//		}
//	}
//	// Every task will be scheduled here
...
//					.build();
//
//			scheduler.addTask(dpid, new Task(TaskType.ADD_GROUP_TBL, dpid, groupMod));
//		}
//	}
//
...
//	// For every newly connected switch,
//	// The controller clears every rules, then install a default rule:
//	// to forward the packet to the controller
