...
//	// if get seperated, a node will be saparated into 4 children
//	// ? Not really. it seems that 4 here is 4 bits.
//	protected int    splitRate     = 4;
//	// Maximum value for subnet is 24.
//	protected int    maxSplitLevel = 24;
//	// Significance? Check n the paper
...
//	}
//
//	protected void updateFlowStatsThread() {
//		UpdateEvent update;
//		while (true) {
//			try {
...
//
//		//
//		// A port with incoming traffic increase? suspicious?
...
//			// purpose here: to find all flows that have been monitored in previous steps
//			// then, check the amount of traffic added to these flows.
//			// based on thi value, we will decided to merge, split or not!!!
//
...
//		}
//		// The purpose is to determine if the change of the flows traffic
//		// correspond to the change of traffic at the port.
//		// Flows with traffic changes do not account for the change
//		// at the port will not be considered.
...
//
//		// locate function
//		// TODO: understand this. Idea: based on the updateValues, it locates if there is any prefixes need to be splitted, blocked or merged.
//		// Notice that updateValues is a Map<IpAddressesWithMask ipaddress, long byteAdded>
//
...
//			// merged refers to OP address prefixes that is merged,
...
//
//		// Register this one with the manager.
//		// Reason: 3 IRadarlistener.
